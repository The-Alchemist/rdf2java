package dfki.rdf.test.propertiesWithNamespaces.bbb;
    ...
    implements Serializable
{
    ...
    protected dfki.rdf.util.PropertyInfo m_bname = dfki.rdf.util.PropertyInfo.createStringProperty( "http://dfki.rdf.test/propertiesWithNamespaces/bbb#", "bname", false );
    ...
    {
        super();
        putRDFSClass( new dfki.rdf.util.RDFResource( "http://dfki.rdf.test/propertiesWithNamespaces/bbb#", "B" ) );
        initPropertyStore();
    }
