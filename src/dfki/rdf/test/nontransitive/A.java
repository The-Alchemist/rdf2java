    ...
    extends dfki.rdf.util.THING
{
    ...
    A m_toTheA;
    dfki.rdf.util.RDFResource m_toTheA__asURI;
    ...
    public dfki.rdf.util.RDFResource GetToTheA__asURI ()
    {
        return m_toTheA__asURI;
    }
    ...
    public void toString (StringBuffer sb, String sIndent)
    {
        ...
        if (m_toTheA != null) {
            sb.append(sIndent+"-> toTheA:\n"+sIndent+"       "+m_toTheA.toStringShort()+"\n");
            // sb.append(sIndent+"-> toTheA:\n"+m_toTheA.toString(sIndent+"       "));
        }
        if (m_toTheA__asURI != null) {
            sb.append(sIndent+"-> toTheA(URI): "+m_toTheA__asURI.toStringShort()+"\n");
        }
        if (!m_toB.isEmpty()) {
