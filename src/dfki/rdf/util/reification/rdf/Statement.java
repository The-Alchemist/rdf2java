    ...
    extends dfki.rdf.util.THING
{
    ...
    protected dfki.rdf.util.PropertyInfo m_subject = dfki.rdf.util.PropertyInfo.createInstanceProperty( "subject", new Class[]{dfki.rdf.util.THING.class}, true );

    /** RDFS2Class: putter for slot subject **/
    public void putSubject (dfki.rdf.util.THING p_subject)
    {
        m_subject.putValue(p_subject);
    }
    public void putSubject (dfki.rdf.util.RDFResource p_subject)
    {
        m_subject.putValue(p_subject);
    }
    ...
    protected dfki.rdf.util.PropertyInfo m_object = dfki.rdf.util.PropertyInfo.createInstanceProperty( "object", new Class[]{String.class, dfki.rdf.util.THING.class}, true );

    /** RDFS2Class: putter for slot object **/
    public void putObject (Object p_object)
    {
        if( p_object == null || ( !(p_object instanceof dfki.rdf.util.RDFResource) && !(p_object instanceof String) && !(p_object instanceof dfki.rdf.util.THING) ) )
            throw new Error("not an allowed class");
        m_object.putValue(p_object);
    }
    public void putObject (dfki.rdf.util.RDFResource p_object)
    {
        m_object.putValue(p_object);
    }
    ...
    protected dfki.rdf.util.PropertyInfo m_predicate = dfki.rdf.util.PropertyInfo.createInstanceProperty( "predicate", new Class[]{String.class, Property.class}, true );

    /** RDFS2Class: putter for slot predicate **/
    public void putPredicate (Object p_predicate)
    {
        if( p_predicate == null || ( !(p_predicate instanceof dfki.rdf.util.RDFResource) && !(p_predicate instanceof String) && !(p_predicate instanceof Property) ) )
            throw new Error("not an allowed class");
        m_predicate.putValue(p_predicate);
    }
    public void putPredicate (dfki.rdf.util.RDFResource p_predicate)
    {
        m_predicate.putValue(p_predicate);
    }
    ...
    public void toString (StringBuffer sb, String sIndent)
    {
        ...
        if (!m_subject.isEmpty()) {
            ...
            for (Iterator it_subject = ((java.util.Collection)m_subject.getValue()).iterator(); it_subject.hasNext(); ) {
                sb.append( sIndent+"       " + ((dfki.rdf.util.RDFResource)it_subject.next()).toStringShort() + "\n" );
