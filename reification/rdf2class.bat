...
set P1=de.de.dfki.rdf.util.reification.rdf
set P2=de.de.dfki.rdf.util.reification.rdfs
...
%JAVA_VM% -cp %CLASSPATH% de.dfki.rdf.util.RDFS2Class %FLAGS% %RDFS_FILE% %OUTPUTDIR% %N1% %P1% %N2% %P2% %N3% %P3% %N4% %P4% %N5% %P5% %N6% %P6% %N7% %P7% %N8% %P8%  %N9% %P9%  %N10% %P10%
pause
