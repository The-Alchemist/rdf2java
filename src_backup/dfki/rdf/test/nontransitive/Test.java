...
import java.util.*;
import dfki.rdf.utils.KnowledgeBase;

public class Test
{
//---------------------------------------------------------------------------
dfki.rdf.utils.KnowledgeBase m_kbCachedObjects;

HashMap m_mapNS2Pkg;
dfki.rdf.utils.RDFImport m_rdfImport;
// HashMap m_mapPkg2NS;
...
Test ()
{
    ...
    m_rdfImport = new dfki.rdf.utils.RDFImport(m_mapNS2Pkg);
