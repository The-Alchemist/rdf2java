    ...
    implements Serializable
{
    //------------------------------------------------------------------------------
    /** RDFS2Class: slot toA **/
    protected dfki.rdf.util.PropertyInfo m_toA = dfki.rdf.util.PropertyInfo.createInstanceProperty( "http://dfki.rdf.test/nontransitive#", "toA", new Class[]{A.class}, true );
    ...
    //------------------------------------------------------------------------------
    /** RDFS2Class: slot toB **/
    protected dfki.rdf.util.PropertyInfo m_toB = dfki.rdf.util.PropertyInfo.createInstanceProperty( "http://dfki.rdf.test/nontransitive#", "toB", new Class[]{B.class}, true );
    ...
    protected dfki.rdf.util.PropertyInfo m_toTheA = dfki.rdf.util.PropertyInfo.createInstanceProperty( "http://dfki.rdf.test/nontransitive#", "toTheA", new Class[]{A.class}, false );
    ...
    public void putToTheA (dfki.rdf.util.RDFResource p_toTheA)
    {
        m_toTheA.putValue(p_toTheA);
    }
    ...
    public dfki.rdf.util.RDFResource getToTheA ()
    {
        return (dfki.rdf.util.RDFResource)m_toTheA.getValue();
    }
    ...
    {
        super();
        putRDFSClass( new dfki.rdf.util.RDFResource( "http://dfki.rdf.test/nontransitive#", "A" ) );
        initPropertyStore();
    }
