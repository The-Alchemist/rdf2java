    ...
    implements Serializable
{
    //------------------------------------------------------------------------------
    /** RDFS2Class: slot toB **/
    protected dfki.rdf.util.PropertyInfo m_toB = dfki.rdf.util.PropertyInfo.createInstanceProperty( "http://dfki.rdf.test/assign#", "toB", new Class[]{B.class}, true );
    ...
    protected dfki.rdf.util.PropertyInfo m_superA = dfki.rdf.util.PropertyInfo.createInstanceProperty( "http://dfki.rdf.test/assign#", "superA", new Class[]{A.class}, false );
    ...
    protected dfki.rdf.util.PropertyInfo m_subA = dfki.rdf.util.PropertyInfo.createInstanceProperty( "http://dfki.rdf.test/assign#", "subA", new Class[]{A.class}, true );
    ...
    {
        super();
        putRDFSClass( new dfki.rdf.util.RDFResource( "http://dfki.rdf.test/assign#", "A" ) );
        initPropertyStore();
    }
