package de.dfki.rdf.test.example1;
    ...
    implements Serializable
{
    ...
    protected de.dfki.rdf.util.PropertyInfo m_hasParent = de.dfki.rdf.util.PropertyInfo.createInstanceProperty( "http://org.dfki/rdf2java/example1#", "hasParent", new Class[]{Person.class}, true );
    ...
    public void putHasParent (de.dfki.rdf.util.RDFResource p_hasParent)
    {
        m_hasParent.putValue(p_hasParent);
    }
    ...
    protected de.dfki.rdf.util.PropertyInfo m_name = de.dfki.rdf.util.PropertyInfo.createStringProperty( "http://org.dfki/rdf2java/example1#", "name", false );
    ...
    {
        super();
        putRDFSClass( new de.dfki.rdf.util.RDFResource( "http://org.dfki/rdf2java/example1#", "Person" ) );
        initPropertyStore();
    }
