package de.dfki.rdf.test.propertiesWithNamespaces.aaa;
    ...
    implements Serializable
{
    ...
    protected de.dfki.rdf.util.PropertyInfo m_ccc_a2b = de.dfki.rdf.util.PropertyInfo.createInstanceProperty( "http://dfki.rdf.test/propertiesWithNamespaces/ccc#", "a2b", new Class[]{de.dfki.rdf.test.propertiesWithNamespaces.bbb.B.class}, false );

    /** RDFS2Class: putter for slot ccc_a2b **/
    public void putCcc_a2b (de.dfki.rdf.test.propertiesWithNamespaces.bbb.B p_ccc_a2b)
    {
        m_ccc_a2b.putValue(p_ccc_a2b);
    }
    public void putCcc_a2b (de.dfki.rdf.util.RDFResource p_ccc_a2b)
    {
        m_ccc_a2b.putValue(p_ccc_a2b);
    }
    ...
    public de.dfki.rdf.test.propertiesWithNamespaces.bbb.B GetCcc_a2b ()
    {
        return (de.dfki.rdf.test.propertiesWithNamespaces.bbb.B)m_ccc_a2b.getValue();
    }
    public de.dfki.rdf.util.RDFResource getCcc_a2b ()
    {
        return (de.dfki.rdf.util.RDFResource)m_ccc_a2b.getValue();
    }
    // RDFS2Class: end of getter for slot ccc_a2b

    //------------------------------------------------------------------------------
    /** RDFS2Class: slot aname **/
    protected de.dfki.rdf.util.PropertyInfo m_aname = de.dfki.rdf.util.PropertyInfo.createStringProperty( "http://dfki.rdf.test/propertiesWithNamespaces/aaa#", "aname", false );
    ...
    //------------------------------------------------------------------------------
    /** RDFS2Class: slot a2b **/
    protected de.dfki.rdf.util.PropertyInfo m_a2b = de.dfki.rdf.util.PropertyInfo.createStringProperty( "http://dfki.rdf.test/propertiesWithNamespaces/aaa#", "a2b", false );
    ...
    {
        super();
        putRDFSClass( new de.dfki.rdf.util.RDFResource( "http://dfki.rdf.test/propertiesWithNamespaces/aaa#", "A" ) );
        initPropertyStore();
    }
