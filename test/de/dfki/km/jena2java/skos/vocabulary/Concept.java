    ...
    implements Serializable
{
    ...
    {
        m_res.addProperty( de.dfki.km.jena2java.skos.vocabulary.SKOS.narrower, narrower );
    }
    ...
    {
        m_res.addProperty( de.dfki.km.jena2java.skos.vocabulary.SKOS.broader, broader );
    }
    ...
    public void addInScheme( de.dfki.km.jena2java.skos.vocabulary.ConceptScheme inscheme )
    {
        m_res.addProperty( de.dfki.km.jena2java.skos.vocabulary.SKOS.inScheme, inscheme );
    }
    ...
    public void addIsSubjectOf( Resource issubjectof )
    {
        m_res.addProperty( de.dfki.km.jena2java.skos.vocabulary.SKOS.isSubjectOf, issubjectof );
    }
    ...
    public void addRelated( Resource related )
    {
        m_res.addProperty( de.dfki.km.jena2java.skos.vocabulary.SKOS.related, related );
    }
